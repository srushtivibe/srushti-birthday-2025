...
<div className="flex justify-center space-x-6 mt-4">
  {/* Instagram */}
  <a
    href="https://www.instagram.com/pyshastra"
    target="_blank"
    rel="noopener noreferrer"
    className="flex flex-col items-center group transition-all duration-300 transform hover:scale-105"
  >
    <div className={`p-2 rounded-lg bg-gradient-to-br from-pink-500 via-red-500 to-yellow-500 group-hover:shadow-md transition-all duration-300 transform group-hover:rotate-3`}>
    ...
    <span className={`mt-1 text-xs font-medium ${darkMode ? 'text-pink-200' : 'text-gray-600'}`}>
      Instagram
    </span>
  </a>
  ...
  {/* YouTube */}
  <a
    href="https://www.youtube.com/@madad9311"
    target="_blank"
    rel="noopener noreferrer"
    className="flex flex-col items-center group transition-all duration-300 transform hover:scale-105"
  >
    <div className={`p-2 rounded-lg bg-gradient-to-br from-red-500 to-red-600 group-hover:shadow-md transition-all duration-300 transform group-hover:rotate-3`}>
      <svg width="18" height="18" viewBox="0 0 24 24" fill="white">
        <path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z"/>
        <polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02" fill="white"/>
      </svg>
    </div>
    <span className={`mt-1 text-xs font-medium ${darkMode ? 'text-red-200' : 'text-gray-600'}`}>
      YouTube
    </span>
  </a>
  ...
  {/* X (Twitter) */}
  <a
    href="https://x.com/n331e5h"
    target="_blank"
    rel="noopener noreferrer"
    className="flex flex-col items-center group transition-all duration-300 transform hover:scale-105"
  >
    <div className={`p-2 rounded-lg bg-black group-hover:shadow-md transition-all duration-300 transform group-hover:rotate-3`}>
      <svg width="18" height="18" viewBox="0 0 24 24" fill="white">
        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
      </svg>
    </div>
    <span className={`mt-1 text-xs font-medium ${darkMode ? 'text-white' : 'text-gray-600'}`}>
      X
    </span>
  </a>
</div>
